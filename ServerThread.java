...
public class ServerThread implements Runnable{
	...
	public void run(){
			...
			while(true){
				...
				*/
                      ...
                      if(!client_quit)
                      {
                          ...
                          else this.board.moveDetective(this.id, target);
                      }
                      else
                      {
                          this.board.erasePlayer(this.id);
     ...
     this.board.count = this.board.count + 1;
     if(this.board.count == this.board.playingThreads)
     {
         for(int i = 0 ; i < this.board.playingThreads; i++)this.board.barrier1.release();
     }
     ...
     this.board.barrier1.acquire();
				...
				*/
                ...
                {
                    for(int i = 0; i < this.board.playingThreads; i++)this.board.barrier2.release();
                    this.board.moderatorEnabler.release();
                }
                this.board.countProtector.release();
